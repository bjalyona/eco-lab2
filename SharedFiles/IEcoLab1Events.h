...
typedef struct IEcoLab1VTblEvents {
	...
	int16_t (ECOCALLMETHOD *OnInsertionSortCalled)(
		/* in */ struct IEcoLab1Events* me, 
		/* in */ const void *startPtr, 
		size_t elem_count
	);

	/* Начало обработки нового элемента для вставки */
	int16_t (ECOCALLMETHOD *OnElementToInsert)(
		/* in */ struct IEcoLab1Events* me, 
		/* in */ const void *element, 
		size_t current_position
	);

	/* Сравнение элементов при поиске позиции для вставки */
	int16_t (ECOCALLMETHOD *OnInsertionComparison)(
		/* in */ struct IEcoLab1Events* me, 
		/* in */ const void *element_to_insert, 
		/* in */ const void *compared_element,
		int comparison_result
	);

	/* Элемент вставлен на окончательную позицию */
	int16_t (ECOCALLMETHOD *OnElementInserted)(
		/* in */ struct IEcoLab1Events* me, 
		/* in */ const void *element, 
